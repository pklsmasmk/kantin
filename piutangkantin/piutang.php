...
<head>
    ...
    <link rel="stylesheet" href="../public/CSS/piutang.css">
</head>
    ...
    <div class="container my-4">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-list"></i> Daftar Piutang (<?= count($piutangRecords) ?> data)</h5>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                                            ...
                                            <div class="mt-3 mt-md-0 d-flex flex-column gap-2">
                                                <a href="bayar.php?id=<?= $record['id'] ?>&type=piutang"
                                                ...
                                                <form method="POST" class="mb-0">
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm w-100"
                                                        onclick="return confirm('Yakin hapus data piutang ini?')">
